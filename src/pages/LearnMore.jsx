...
const AGENTS = [
    {
        ...
        desc: "Takes your Java microservice description and designs the full system architecture. It defines services, their responsibilities, and how they communicate — producing the blueprint every other agent builds on.",
        outputs: ["Service boundaries", "Component diagram", "Communication patterns", "Technology decisions"],
    },
    {
        num: "02",
        icon: "☕",
        ...
        bg: "rgba(187, 41, 255, 0.1)",
        border: "rgba(187, 41, 255, 0.2)",
        desc: "Generates production-ready Java source code based on the architecture design. Produces the full Spring Boot structure — controllers, services, repositories, and models — ready to compile and run.",
        outputs: ["Spring Boot controllers", "Service layer", "Repository interfaces", "Entity models"],
    },
    {
        num: "03",
        icon: "🐳",
        ...
        bg: "rgba(187, 41, 255, 0.1)",
        border: "rgba(187, 41, 255, 0.2)",
        desc: "Creates a Dockerfile tailored to the specific microservice. Uses a multi-stage build to keep the image lean, sets the right environment variables, and outputs a production-ready container configuration.",
        outputs: ["Multi-stage Dockerfile", "Build optimization", "Environment config", "Docker Compose snippet"],
    },
    {
        num: "04",
        icon: "🧪",
        ...
        bg: "rgba(187, 41, 255, 0.1)",
        border: "rgba(187, 41, 255, 0.2)",
        desc: "Writes JUnit unit tests for the generated Java code. Covers happy paths, edge cases, and error scenarios using Mockito — so the codebase is verifiable and reliable from day one.",
        outputs: ["JUnit 5 test classes", "Mockito mocks", "Happy path tests", "Edge case coverage"],
    },
    {
        num: "05",
        icon: "🔍",
        name: "Error Report Analyzer",
        color: "#bb29ff",
        bg: "rgba(187, 41, 255, 0.1)",
        border: "rgba(187, 41, 255, 0.2)",
        desc: "Scans the generated code and tests for potential bugs, security vulnerabilities, and antipatterns. Produces a prioritized report with clear fix recommendations so issues are caught before they reach production.",
        outputs: ["Bug detection report", "Security vulnerabilities", "Code antipatterns", "Fix recommendations"],
    },
];
...
const TECH = [
    ...
    { icon: "🤖", name: "GPT-4.1",      desc: "AI model"               },
    { icon: "⚛️", name: "React",        desc: "Frontend"               },
    { icon: "🐬", name: "MySQL",        desc: "Conversation history"   },
...
const FAQ = [
    {
        ...
        a: "No — the app runs in Mock Mode by default, which returns realistic example designs instantly. When you get an API key, set USE_MOCK=false in the backend .env and the system uses real GPT-4.1.",
    },
    {
        q: "What kind of systems can it design?",
        a: "It specializes in Java Spring Boot microservices — e-commerce, banking, healthcare, SaaS platforms, REST APIs, and more. It's optimized for MySQL, Spring Security JWT, and Docker deployments.",
    },
    {
        q: "Can I export the results?",
        a: "Yes — every design result can be exported as JSON from the Dashboard. The JSON includes all agent outputs: architecture diagram, Java source code, Dockerfile, unit tests, and error report.",
    },
    {
        q: "Does it remember previous conversations?",
        a: "Yes — conversations are stored per session in MySQL. Each project has its own session history so you can revisit and continue previous design discussions.",
    },
];
        ...
        <div className="min-h-screen bg-[#0f0a1a] text-[#f8fafc]" style={{ fontFamily: "'DM Sans', sans-serif" }}>
            ...
            <section className="text-center px-6 py-20 max-w-3xl mx-auto">
                ...
                <h1 className="text-5xl font-bold text-white mb-6 leading-tight">
                    Five agents.<br />
                    <span className="text-[#bb29ff]">One complete microservice.</span>
                </h1>
                <p className="text-gray-400 text-lg leading-relaxed">
                    Each agent is a specialist. They run in sequence as a pipeline —
                    the output of one becomes the input of the next, from description to deployable code.
                </p>
            </section>
            ...
            <section className="text-center py-16 px-6 border-t border-white/5">
                ...
                <p className="text-gray-500 mb-8">Create a free account and design your first microservice in under a minute.</p>
                <button
